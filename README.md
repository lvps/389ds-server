...
|---------------------------------|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| dirsrv_product                  | major distribution dependent| There are two main release. The free **389 Directory Server** and the supported **Red Hat Directory Server**. With the free releases you can trust on the default setting. Otherwise you can configure this value for your need. At the moment the only non default value tested is  `'@redhat-ds:11'` for the Red Hat Directory Server 11, available in Red Hat EL8.                                                                                                                                                        | **No**         |
