...
|---------------------------------|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| dirsrv_product                  | major distribution dependent| There are two main release. The free **389 Directory Server** and the supported **Red Hat Directory Server**. With the free relase you can trust on the default setting. Otherwise you can configure this value for your need. At the moment the only tested and non default value is  `'@redhat-ds:11'` for the Red Hat Directory Server 11, available for Red Hat EL8.                                                                                                                                                        | **No**         |
